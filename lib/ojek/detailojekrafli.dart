...
final Uri _whatsappUrl = Uri.parse(
    'https://api.whatsapp.com/send?phone=62895362104800&text=Halo%20saya%20mau%20pesan%20Ojek');

class Detailojekrafli extends StatefulWidget {
  const Detailojekrafli({super.key});

  @override
  State<Detailojekrafli> createState() => _DetailojekrafliState();
}

class _DetailojekrafliState extends State<Detailojekrafli> {
  int _currentIndex = 0;
