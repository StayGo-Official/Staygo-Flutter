...
final Uri _whatsappUrl = Uri.parse(
    'https://api.whatsapp.com/send?phone=6282285613901&text=Halo%20saya%20mau%20pesan%20Ojek');

class Detailojekbosmuda extends StatefulWidget {
  const Detailojekbosmuda({super.key});

  @override
  State<Detailojekbosmuda> createState() => _DetailojekbosmudaState();
}

class _DetailojekbosmudaState extends State<Detailojekbosmuda> {
  int _currentIndex = 0;
