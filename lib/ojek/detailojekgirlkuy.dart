...
final Uri _whatsappUrl = Uri.parse(
    'https://api.whatsapp.com/send?phone=6282253796283&text=Halo%20saya%20mau%20pesan%20Ojek');

class Detailojekgirlkuy extends StatefulWidget {
  const Detailojekgirlkuy({super.key});

  @override
  State<Detailojekgirlkuy> createState() => _DetailojekgirlkuyState();
}

class _DetailojekgirlkuyState extends State<Detailojekgirlkuy> {
  int _currentIndex = 0;
