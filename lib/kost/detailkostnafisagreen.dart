...
final Uri _url = Uri.parse('https://www.google.com/maps?q=5.213042,97.067679');
...
class DetailKostNafisaGreen extends StatefulWidget {
  const DetailKostNafisaGreen({super.key});

  @override
  State<DetailKostNafisaGreen> createState() => _DetailKostNafisaGreenState();
}

class _DetailKostNafisaGreenState extends State<DetailKostNafisaGreen> {
  int _currentIndex =
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Jln. PNKA, Blang Pulo, Muara Satu, Lhokseumawe',
                  ...
                  Text(
                    'Luas kamar 4 x 5 meter, kamar mandi dalam, area parkir, lingkungan nyaman.',
                    style: TextStyle(
                      fontSize: 14,
