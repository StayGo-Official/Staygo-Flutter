...
final Uri _url = Uri.parse('https://www.google.com/maps?q=5.213139,97.067304');
final Uri _whatsappUrl = Uri.parse('https://api.whatsapp.com/send?phone=6282273053494&text=Halo%20saya%20mau%20bertanya%20tentang%20Kamar%20Kost%20nya');

class DetailKostMuchtar extends StatefulWidget {
  const DetailKostMuchtar({super.key});

  @override
  State<DetailKostMuchtar> createState() => _DetailKostMuchtarState();
}

class _DetailKostMuchtarState extends State<DetailKostMuchtar> {
  int _currentIndex =
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _buildCategoryButton('assets/kamar-icon.png', 'Kamar'),
                    ],
                  ),
                  ...
                  Text(
                    'Luas kamar 3 x 4 meter, kamar mandi luar, area parkir, lingkungan nyaman',
                    style: TextStyle(
                      fontSize: 14,
