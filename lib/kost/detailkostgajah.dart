...
final Uri _url = Uri.parse('https://www.google.com/maps?q=5.208279, 97.070873');
...
class DetailKostGajah extends StatefulWidget {
  const DetailKostGajah({super.key});

  @override
  State<DetailKostGajah> createState() => _DetailKostGajahState();
}

class _DetailKostGajahState extends State<DetailKostGajah> {
  int _currentIndex =
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _buildCategoryButton('assets/kamar-icon.png', 'Kasur'),
                  ...
                  Text(
                    'Luas kamar 3 x 4 meter, kamar mandi dalam, area parkir, lingkungan nyaman',
                    style: TextStyle(
                      fontSize: 14,
